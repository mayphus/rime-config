...
local newKeyLayout(isDark=false, isPortrait=false) =
  ...
  + newMarkedAlphabeticButton(params.keyboard.qButton, isDark, normalButtonSize + hintStyle)
  + newMarkedAlphabeticButton(params.keyboard.wButton, isDark, normalButtonSize + hintStyle)
  + newMarkedAlphabeticButton(params.keyboard.eButton, isDark, normalButtonSize + hintStyle)
  + newMarkedAlphabeticButton(params.keyboard.rButton, isDark, normalButtonSize + hintStyle)
  + newMarkedAlphabeticButton(params.keyboard.tButton, isDark, normalButtonSize + hintStyle)
  + newMarkedAlphabeticButton(params.keyboard.yButton, isDark, normalButtonSize + hintStyle)
  + newMarkedAlphabeticButton(params.keyboard.uButton, isDark, normalButtonSize + hintStyle)
  + newMarkedAlphabeticButton(params.keyboard.iButton, isDark, normalButtonSize + hintStyle)
  + newMarkedAlphabeticButton(params.keyboard.oButton, isDark, normalButtonSize + hintStyle)
  + newMarkedAlphabeticButton(params.keyboard.pButton, isDark, normalButtonSize + hintStyle)
  + basicStyle.newAlphabeticButton(
  ...
  + newMarkedAlphabeticButton(params.keyboard.aButton, isDark, normalButtonSize + hintStyle)
  + newMarkedAlphabeticButton(params.keyboard.sButton, isDark, normalButtonSize + hintStyle)
  + newMarkedAlphabeticButton(params.keyboard.dButton, isDark, normalButtonSize + hintStyle)
  + newMarkedAlphabeticButton(params.keyboard.fButton, isDark, normalButtonSize + hintStyle)
  + newMarkedAlphabeticButton(params.keyboard.gButton, isDark, normalButtonSize + hintStyle)
  + newMarkedAlphabeticButton(params.keyboard.hButton, isDark, normalButtonSize + hintStyle)
  + newMarkedAlphabeticButton(params.keyboard.jButton, isDark, normalButtonSize + hintStyle)
  + newMarkedAlphabeticButton(params.keyboard.kButton, isDark, normalButtonSize + hintStyle)
  + newMarkedAlphabeticButton(params.keyboard.lButton, isDark, normalButtonSize + hintStyle)
  + basicStyle.newAlphabeticButton(
  ...
  + newMarkedAlphabeticButton(params.keyboard.zButton, isDark, normalButtonSize + hintStyle)
  + newMarkedAlphabeticButton(params.keyboard.xButton, isDark, normalButtonSize + hintStyle)
  + newMarkedAlphabeticButton(params.keyboard.cButton, isDark, normalButtonSize + hintStyle)
  + newMarkedAlphabeticButton(params.keyboard.vButton, isDark, normalButtonSize + hintStyle)
  + newMarkedAlphabeticButton(params.keyboard.bButton, isDark, normalButtonSize + hintStyle)
  + newMarkedAlphabeticButton(params.keyboard.nButton, isDark, normalButtonSize + hintStyle)
  + newMarkedAlphabeticButton(params.keyboard.mButton, isDark, normalButtonSize + hintStyle)
  + basicStyle.newAlphabeticButton(
