...
cp "$ROOT_DIR/jyut6ping3.chars.dict.yaml" "$OUT_DIR/"
cp "$ROOT_DIR/jyut6ping3.words.dict.yaml" "$OUT_DIR/"
cp "$ROOT_DIR/jyut6ping3.phrase.dict.yaml" "$OUT_DIR/"
cp "$ROOT_DIR/jyut6ping3.lettered.dict.yaml" "$OUT_DIR/"
cp "$ROOT_DIR/jyut6ping3.maps.dict.yaml" "$OUT_DIR/"
cp "$ROOT_DIR/luna_pinyin.dict.yaml" "$OUT_DIR/"
cp "$ROOT_DIR/essay-cantonese.txt" "$OUT_DIR/"
