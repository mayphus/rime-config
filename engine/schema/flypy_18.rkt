...
(define schema-doc
  (mapping
   ...
   (kv "speller"
       (mapping
        (kv "alphabet" "qwryuipasfhjlzxvbm")
        (kv "delimiter" " '")
        (kv "algebra"
            (sequence
             "erase/^xx$/"
...
(define config-files
  (bundle
   (yaml-file "flypy_18.schema.yaml" schema-doc)
   (make-mobile-custom-file
    "flypy_18.custom.yaml"
